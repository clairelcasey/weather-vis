...
class WeatherWheel {
    constructor(container) {
        ...
        this._condColors = [
            { id: "Sunny", color: "#fff3b0", icon: "" },
            { id: "Partly_cloudy", color: "#e7d8c9", icon: "" },
    ...
    _process() {
        ...
        this._chartData = this._data.map(d => {
            ...
            // console.log(d[field.date])
            const datum = {
                // dateStr: d[field.date],
                dateStr: `
                    ${d[field.date].getUTCMonth()+1}
                    /${d[field.date].getUTCDate()}/
                    ${d[field.date].getUTCFullYear()}`,
                date: date,
                month: date.getMonth(),
                low: d[field.low],
                high: d[field.high],
        ...
        this._year = this._chartData[0].date.getUTCFullYear();
